...
int main(){
    ...
    freopen("TTM09.in", "w", stdout);
#endif

    srand((unsigned) time(NULL));

    //n = 100000, m = 100000, C1 = 1000000000, C2 = 10000;
     n = 100000, m = 100000, C1 = 10000000, C2 = 1000;

    cout << n << " " << m << endl;
    REP(i, n) cout << random32(-C1, C1) << " ";
    cout << endl;
    ...
    DO(m){
        ...
        if (rand() % 1000 < 1){
            int t = random32(0, tt-1);
            cout << "B" << " " << t << endl;
            tt = t;
        }
        else {

        int t = dice(), l = random32(1, n), r = random32(1, n);
        if (l > r) swap(l, r);
        ...
        if (t < 3){
            if (tt == 0 || t != 0){
                ...
                cout << "H " << l << " " << r << " " << random32(0, tt-1) << endl;
            }
        }
        else {
            cout << "C ";

            cout <<  l << " " << r << " " << random32(-C2, C2) << endl;

            /*
            if (tt == 0 || t != 3){
                cout << "1 "  << l << " " << r << " " << random32(-C2, C2) << endl;
            }
            else {
                cout << "2 "  << l << " " << r << " " << random32(-C2, C2) << " " << random(1, tt) << endl;
            }
            */
            ++tt;
        }
